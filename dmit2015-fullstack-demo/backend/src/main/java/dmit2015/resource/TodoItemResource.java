 ...
 *
 ...
 -d '{"id":4,"name":"Demo DMIT2015 Assignment 1","complete":true,"version":0}' \
 -H 'Content-Type:application/json'

 curl -i -X PUT http://localhost:8080/restapi/TodoItems/4 \
 -d '{"id":4,"name":"Work on DMIT2015 Assignment 2","complete":true,"version":1}' \
 -H 'Content-Type:application/json'
...
public class TodoItemResource {
    ...
    public Response postTodoItem(TodoItem newTodoItem) {
        ...
        Set<String> groups = _callerPrincipal.getGroups();
